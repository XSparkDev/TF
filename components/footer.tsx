      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12 items-start">
          ...
          <div className="space-y-4 md:mt-6">
            ...
            <div className="flex rounded-md overflow-hidden bg-background text-foreground max-w-md">
              <input
                type="email"
                placeholder="Email"
                className="flex-1 px-4 py-3 text-sm md:text-base bg-background text-foreground outline-none"
              />
              <button className="px-6 bg-primary text-primary-foreground text-xl font-semibold flex items-center justify-center">
                <span>&rarr;</span>
              </button>
            </div>
          </div>
