        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.linkedin.com/company/tshegofentse-facilities-engineering/?originalSubdomain=za" target="_blank" rel="noopener noreferrer" className="bg-background/10 hover:bg-background/20 p-2 rounded-lg transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
