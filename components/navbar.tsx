            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                ...
                <nav className="flex flex-col gap-4 mt-8">
                  {navLinks.map((link) => (
                    <Link
                      ...
                      className="text-lg font-medium text-foreground hover:text-primary transition-colors uppercase tracking-wide py-2 border-b border-border/50"
                    >
                      {link.name}
                    </Link>
                  ))}
                ...
                <div className="mt-8 pt-8 border-t border-border/50">
                  <p className="text-sm font-semibold text-foreground/70 mb-4 uppercase tracking-wide">Follow Us</p>
