      ...
      >
        <div className="container mx-auto px-4 md:px-6 py-0 flex items-center justify-between gap-4 md:gap-8">
            ...
            {isMounted ? (
              <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                ...
                <SheetContent side="right" className="w-[300px] sm:w-[400px] p-0 flex flex-col">
                  ...
                  {/* Social Icons - Mobile */}
                  <div className="px-6 pt-4 pb-6 border-t border-border/30 mt-auto">
                    <p className="text-xs font-semibold text-foreground/80 mb-3 uppercase tracking-wider">Follow Us</p>
                    <div className="flex items-center gap-3">
                      <a href="https://web.facebook.com/tshegofentseza/?_rdc=1&_rdr#" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors p-1.5 hover:bg-muted/50 rounded-md">
                      ...
                      <a href="https://www.google.com/search?q=TSHEGOFENTSE&oq=TSHEGOFENTSE&aqs=chrome..69i57j0i30j69i60l4j69i61.4052j0j4&sourceid=chrome&ie=UTF-8" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors p-1.5 hover:bg-muted/50 rounded-md">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-5 flex-shrink-0">
            ...
            <a href="https://www.google.com/search?q=TSHEGOFENTSE&oq=TSHEGOFENTSE&aqs=chrome..69i57j0i30j69i60l4j69i61.4052j0j4&sourceid=chrome&ie=UTF-8" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="currentColor" />
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="currentColor" />
                <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="currentColor" />
